        ...
        if ("now".equalsIgnoreCase(input)) {
            ...
            try {
                ...
                if (parsed instanceof LocalDateTime) {
                    ...
                    throw new InvalidFlagFormat(Msg.REGION__FLAGS__VALUE__INVALID__UNRECOGNIZED.get());
                }
            } catch (DateTimeParseException ignored) {
                throw new InvalidFlagFormat(Msg.REGION__FLAGS__VALUE__INVALID__DATETIME.get());
            }
        }
    }
