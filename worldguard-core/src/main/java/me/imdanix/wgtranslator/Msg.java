...
public enum Msg {
    ...
    REGION__PARENT__CURRENT__INHERITANCE__INFO("(Current inheritance on '{parent}':", "parent"),
    REGION__PARENT__CURRENT__INHERITANCE__INFOEND(")"),
    REGION__PARENT__CURRENT__INHERITANCE__SHORT("(Current inheritance:"),
    REGION__PARENT__CURRENT__INHERITANCE__SHORTEND(")"),
    ...
    CONFIG__WORLD__FIRE_DISABLED("&eFire spread is currently globally disabled for this world."),
    ...
    REGION__INFO__PARENT__CLICKINFO("Click for info"),
    REGION__INFO__PARENT__END(")"),
    REGION__INFO__PARENT__UNLINK("Click to unlink parent"),
    REGION__INFO__PARENT__UNLINKCMD("[X]"),
