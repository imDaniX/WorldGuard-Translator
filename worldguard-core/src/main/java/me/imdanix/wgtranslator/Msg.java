...
public enum Msg {
    ...
    REGION_FLAGS_VALUE_DEFAULT_TELEPORT("&dTeleported you to the region '%id%'."),
    ...
    REGION_FLAGS_VALUE_INVALID_BOOLEAN("Not a yes/no value: {input}", "input"),
    REGION_FLAGS_VALUE_INVALID_REGISTRY("Unknown {registry}: {key}", "registry", "key"),
    REGION_FLAGS_VALUE_INVALID_ENUM("Unknown value '{input}' in {class}", "input", "class"),
    REGION_FLAGS_VALUE_INVALID_INTEGER("Not a number: {input}", "input"),
    REGION_FLAGS_VALUE_INVALID_DOUBLE("Not a number: {input}", "input"),
    REGION_FLAGS_VALUE_INVALID_MAP("Input must be in a 'key:value,key1=value1' format. Either ':' or '=' can be used."),
    REGION_FLAGS_VALUE_INVALID_UUID("Not a valid uuid: {input}", "input"),
    REGION_FLAGS_VALUE_INVALID_ENTITYTYPE("Unknown entity type: {input}", "input"),
    REGION_FLAGS_VALUE_INVALID_OUTSIDE("You can't set that flag outside of the region boundaries."),
    REGION_FLAGS_VALUE_INVALID_LOCATION("Expected 'here' or x,y,z."),
    REGION_FLAGS_VALUE_INVALID_PLUGIN("The plugin that registered this flag is not currently installed"),
    REGION_FLAGS_VALUE_INVALID_UNRECOGNIZED("Unrecognized input."),
    REGION_FLAGS_VALUE_INVALID_DATETIME("Expected 'now' or ISO 8601 formatted input."),
