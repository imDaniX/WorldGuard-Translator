...
public class MsgTest {
    ...
    @CsvSource(delimiter = '|', textBlock = """
        ...
        '&lBold' | '§lBold'
        '&rReset' | '§rReset'
        '&#ff0000Red hex' | '§x§f§f§0§0§0§0Red hex'
        '&#00ff00Green hex' | '§x§0§0§f§f§0§0Green hex'
        ...
        '&#1234567Too long' | '&#1234567Too long'
        '&#ghijklNon hex' | '&#ghijklNon hex'
        '&x&k&lMultiple codes' | '§x§k§lMultiple codes'
        '&KReset uppercase' | '§KReset uppercase'
